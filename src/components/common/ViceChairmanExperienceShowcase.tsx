...
export default function ViceChairmanExperienceShowcase() {
  ...
  return (
    <div className="pt-6 space-y-10 border-t border-[#CCE5E3] mt-6" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="bg-gradient-to-r from-[#07262B] via-[#0A3D44] to-[#07262B] text-white p-6 sm:p-8 rounded-2xl shadow-lg border border-[#0B6E7B]/40 space-y-5 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#0B6E7B]/30 pb-4">
          <div className="space-y-1">
            <span className="font-narrow text-xs font-black text-[#2DD4BF] tracking-widest uppercase block">
            ...
            <p className="font-sans text-xs sm:text-sm text-white/80 max-w-2xl">
          ...
          <div className="flex flex-wrap items-center gap-2.5 shrink-0">
            {viceChairmanData.welcomeDay2022.driveLink && (
              <a
                ...
                className="px-4 py-2 bg-[#0B6E7B] text-white hover:bg-[#08545E] transition-colors rounded-xl text-xs font-narrow font-black tracking-wider uppercase inline-flex items-center gap-2 shadow-md cursor-pointer"
              >
                <i className="fa-brands fa-google-drive text-sm text-[#2DD4BF] pointer-events-none"></i>
            ...
            {viceChairmanData.welcomeDay2022.newsLink && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 bg-white/10 text-white hover:bg-[#0B6E7B] transition-all rounded-xl text-xs font-narrow font-black tracking-wider uppercase inline-flex items-center gap-2 border border-[#0B6E7B]/40 cursor-pointer"
              >
                <i className="fa-solid fa-newspaper text-sm text-[#2DD4BF] pointer-events-none"></i>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          {midAutumn2022Images.length > 11 && (
            <div
              ...
              className="aspect-4/3 w-full rounded-xl overflow-hidden bg-[#07262B] text-white border border-[#0B6E7B]/40 cursor-pointer group relative flex flex-col items-center justify-center p-2 text-center shadow-xs hover:bg-[#0A3D44] transition-colors"
            >
              <i className="fa-solid fa-moon text-xl text-[#2DD4BF] mb-1 group-hover:scale-110 transition-transform pointer-events-none"></i>
              <span className="font-narrow text-xs font-black uppercase tracking-wider pointer-events-none">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          {ousGotTalentImages.length > 11 && (
            <div
              ...
              className="aspect-4/3 w-full rounded-xl overflow-hidden bg-[#07262B] text-white border border-[#0B6E7B]/40 cursor-pointer group relative flex flex-col items-center justify-center p-2 text-center shadow-xs hover:bg-[#0A3D44] transition-colors"
            >
              <i className="fa-solid fa-star text-xl text-[#2DD4BF] mb-1 group-hover:scale-110 transition-transform pointer-events-none"></i>
              <span className="font-narrow text-xs font-black uppercase tracking-wider pointer-events-none">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          ...
          {spring2021Images.length > 11 && (
            <div
              ...
              className="aspect-4/3 w-full rounded-xl overflow-hidden bg-[#07262B] text-white border border-[#0B6E7B]/40 cursor-pointer group relative flex flex-col items-center justify-center p-2 text-center shadow-xs hover:bg-[#0A3D44] transition-colors"
            >
              <i className="fa-solid fa-paint-roller text-xl text-[#2DD4BF] mb-1 group-hover:scale-110 transition-transform pointer-events-none"></i>
              <span className="font-narrow text-xs font-black uppercase tracking-wider pointer-events-none">
